...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'royalfashion_80666686649196f62042_20210629095906_archive.zip';
	const ARCHIVE_SIZE		 = '65570709';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8066668-29095906';
    const SECONDARY_PACKAGE_HASH = '0493dbd-29095906';
	const VERSION			 = '1.4.1';
